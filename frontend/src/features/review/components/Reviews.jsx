...
export const Reviews = ({productId,averageRating}) => {
  ...
  return (
        <Stack mt={10} rowGap={5} alignSelf={"flex-start"}  width={is480?"90vw":is840?"25rem":'40rem'}>


            <Stack>
                <Typography gutterBottom variant='h3' fontWeight={800}>Customer Reviews</Typography>
                {
                    reviews?.length?(
                        <Stack rowGap={3}>

                            <Stack rowGap={1} >
                                <Typography variant='h3' fontWeight={800}>{averageRating}.0</Typography>
